...
3. Засечь время выполнения: long a = System.currentTimeMillis().
4. Пройти по всему массиву и для каждой ячейки просчитать новое значение
5. Проверить время окончания метода.
